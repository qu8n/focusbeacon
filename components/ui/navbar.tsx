...
export const NavbarItem = React.forwardRef(function NavbarItem(
  ...
  const classes = clsx(
    // Base
    "relative flex min-w-0 items-center gap-2 rounded-lg p-2 text-left text-base/6 font-medium text-stone-950 sm:text-sm/5",
    ...
    <span className={clsx(className, "relative")}>
      {current && (
        <motion.span
          ...
          className="absolute inset-x-2 -bottom-2.5 h-0.5 rounded-full bg-stone-950"
        />
      )}
      {"href" in props ? (
        <LinkInternal
