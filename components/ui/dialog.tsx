            ...
            >
              <Headless.DialogPanel
                className={clsx(
                  className,
                  sizes[size],
                  "row-start-2 w-full min-w-0 rounded-t-3xl bg-white p-[--gutter] shadow-lg ring-1 ring-zinc-950/10 [--gutter:theme(spacing.8)] sm:mb-auto sm:rounded-lg dark:bg-zinc-900 dark:ring-white/10 forced-colors:outline"
                )}
              >
                {children}
              </Headless.DialogPanel>
